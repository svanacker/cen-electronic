...
#define MOTOR_BOARD_INPUT_BUFFER_LENGTH              30
#define MOTOR_BOARD_OUTPUT_BUFFER_LENGTH             30

#define MOTOR_BOARD_I2C_INPUT_BUFFER_LENGTH          MOTOR_BOARD_INPUT_BUFFER_LENGTH
#define MOTOR_BOARD_I2C_OUTPUT_BUFFER_LENGTH         MOTOR_BOARD_OUTPUT_BUFFER_LENGTH
