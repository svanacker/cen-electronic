...
#define MAIN_BOARD_SERIAL_PORT_MOTOR_NOTIFY  SERIAL_PORT_2
...
#define MAIN_BOARD_MOTOR_NOTIFY_INPUT_BUFFER_LENGTH        200
#define MAIN_BOARD_MOTOR_NOTIFY_OUTPUT_BUFFER_LENGTH       200
