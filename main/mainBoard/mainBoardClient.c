...
// i2c->Motor
static char motorBoardI2cInputBufferArray[MAIN_BOARD_LINK_TO_MOTOR_BOARD_BUFFER_LENGTH];
...
// DISPATCHER UART
// uart->Motor
static char motorBoardUartInputBufferArray[MAIN_BOARD_LINK_TO_MOTOR_BOARD_BUFFER_LENGTH];
