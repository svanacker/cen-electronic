...
#define MAIN_BOARD_LCD_INPUT_BUFFER_LENGTH        MAIN_BOARD_DEBUG_INPUT_BUFFER_LENGTH
#define MAIN_BOARD_LCD_OUTPUT_BUFFER_LENGTH        MAIN_BOARD_DEBUG_OUTPUT_BUFFER_LENGTH
#define MAIN_BOARD_LCD_SERIAL_SPEED                9600
