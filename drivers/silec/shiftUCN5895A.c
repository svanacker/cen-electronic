...
void writeCharSilec(Silec* silec,int data){
    ...
    for (i = 0; i <7; i++){
        int octet = 0;
        value = CGROM_7x6 [caractere] [0] & (0x01<<i);
        value = value >>i;
        octet = octet << 1;
        octet = octet | value;
        value = CGROM_7x6 [caractere] [1] & (0x01<<i);
        value = value >>i;
        octet = octet << 1;
        octet = octet | value;
        value = CGROM_7x6 [caractere] [2] & (0x01<<i);
        value = value >>i;
        octet = octet << 1;
        octet = octet | value;
        value = CGROM_7x6 [caractere] [3] & (0x01<<i);
        value = value >>i;
        octet = octet << 1;
        octet = octet | value;
        value = CGROM_7x6 [caractere] [4] & (0x01<<i);
        value = value >>i;
        octet = octet << 1;
        octet = octet | value;
        value = CGROM_7x6 [caractere] [5] & (0x01<<i);
        value = value >>i;
        octet = octet << 1;
        octet = octet | value;
        value = CGROM_7x6 [caractere] [6] & (0x01<<i);
        value = value >>i;
        //octet = octet << 1;
        octet = octet | value;
...
/*    for (i = 0 ;i < 5; i++){ 
        octet = CGROM_7x6 [50] [0] & 0xFD;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [1] & 0xFD;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [2] & 0xFD;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [3] & 0xFD;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [4] & 0xFD;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [5] & 0xFD;
        octet = octet << 1;
    }        
    CGRAM [1][0] = octet ;
    
    for (i = 0 ;i < 5; i++){ 
        octet = CGROM_7x6 [50] [0] & 0xFB;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [1] & 0xFB;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [2] & 0xFB;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [3] & 0xFB;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [4] & 0xFB;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [5] & 0xFB;
        octet = octet << 1;
    }        
    CGRAM [2][0] = octet ;
    
    for (i = 0 ;i < 5; i++){ 
        octet = CGROM_7x6 [50] [0] & 0xF7;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [1] & 0xF7;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [2] & 0xF7;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [3] & 0xF7;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [4] & 0xF7;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [5] & 0xF7;
        octet = octet << 1;
    }        
    CGRAM [3][0] = octet ;
    
    for (i = 0 ;i < 5; i++){ 
        octet = CGROM_7x6 [50] [0] & 0xEF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [1] & 0xEF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [2] & 0xEF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [3] & 0xEF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [4] & 0xEF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [5] & 0xEF;
        octet = octet << 1;
    }        
    CGRAM [4][0] = octet ;
    
    for (i = 0 ;i < 5; i++){ 
        octet = CGROM_7x6 [50] [0] & 0xDF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [1] & 0xDF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [2] & 0xDF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [3] & 0xDF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [4] & 0xDF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [5] & 0xDF;
        octet = octet << 1;
    }        
    CGRAM [5][0] = octet ;
    
    for (i = 0 ;i < 5; i++){ 
        octet = CGROM_7x6 [50] [0] & 0xBF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [1] & 0xBF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [2] & 0xBF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [3] & 0xBF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [4] & 0xBF;
        octet = octet << 1;
        octet = CGROM_7x6 [50] [5] & 0xBF;
        octet = octet << 1;
    }        
    CGRAM [6][0] = octet ;
 */   
    while (1){
        for (i = 0; i < 7; i++ ){
            _writeUCN5895(silec, i,CGRAM [i][0],CGRAM [i][1],CGRAM [i][2]);              
