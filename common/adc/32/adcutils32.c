...
#define CONFIGPORT ( ENABLE_AN2_ANA | ENABLE_AN3_ANA | ENABLE_AN4_ANA | ENABLE_AN5_ANA )
#define CONFIGSCAN (SKIP_SCAN_AN0 | SKIP_SCAN_AN1 | SKIP_SCAN_AN7 | SKIP_SCAN_AN9 | SKIP_SCAN_AN6 | SKIP_SCAN_AN8 | SKIP_SCAN_AN10 | SKIP_SCAN_AN11 | SKIP_SCAN_AN12 | SKIP_SCAN_AN13 | SKIP_SCAN_AN14 )

static int configPortDAC;
static int configScanDAC;
