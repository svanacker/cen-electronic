...
#define COMMAND_GET_END_DETECTION_PARAMETER_FAILED   'f'
#define COMMAND_SET_END_DETECTION_PARAMETER_FAILED   'f'

#define COMMAND_GET_END_DETECTION_PARAMETER_REACHED   'r'
#define COMMAND_SET_END_DETECTION_PARAMETER_REACHED   'R'

#define COMMAND_GET_END_DETECTION_PARAMETER_SHOCKED   'k'
#define COMMAND_SET_END_DETECTION_PARAMETER_SHOCKED   'K'
