...
DeviceDescriptor* getDataDispatcherDeviceDescriptor() {
    initDeviceDescriptor(&descriptor,
            &deviceDataDispatcherInit,
            &deviceDataDispatcherShutDown,
            &deviceDataDispatcherIsOk,
            &deviceDataDispatcherHandleRawData,
            NULL);
