...
#define BACK_SIDE_LEFT_SENSOR_ANGLE_DEGREE      0.0f
#define BACK_SIDE_RIGHT_SENSOR_ANGLE_DEGREE     0.0f
...
#define BACK_SIDE_LEFT_SENSOR_DISTANCE_THRESHOLD     200
#define BACK_SIDE_RIGHT_SENSOR_DISTANCE_THRESHOLD    200
