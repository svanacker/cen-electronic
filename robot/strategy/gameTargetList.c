...
void addGameTarget(GameTarget* target, char* targetName, float potentialGain, Location* startLocation, Location* endLocation) {
    ...
    if (size < MAX_TARGET) {
        ...
        target->startLocation = startLocation;
