...
#define DROP_ZONE_1_TO_MIDDLE_BULLION_1_SPEED_FACTOR			MOTION_SPEED_FACTOR_LOW
...
#define DROP_ZONE_1_TO_MIDDLE_BULLION_1_ACCELERATION_FACTOR		MOTION_ACCELERATION_FACTOR_LOW
